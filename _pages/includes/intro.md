...
# Research:
Our group focuses on the challenges of computer vision and large models in real-world applications (e.g., precision medicine, intelligent transportation, remote sensing), mainly on **accurate recognition under complex imaging conditions**, including image quality enhancement, large-model-assisted data annotation, and fine-grained feature extraction.
